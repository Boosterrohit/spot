      ...
      <div className="container">
        <div className="row d-flex justify-content-center">
          <div className="col-sm-6 col-lg-3 mt-4">
            ...
            <p className="text1">
              Our commitment to quality, customer satisfaction, and attention to
              detail sets us apart from the competition. We are dedicated to
              ensuring that your new wardrobe meets and exceeds your
              expectations.
            </p>
          </div>
          <div className="col-sm-6 col-lg-3 mt-4">
